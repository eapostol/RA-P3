...
var App = function () {
   function App() {
      ...
      this.cartIcon.addEventListener("click", function (e) {
         _this.shoppingCart.createCartView(_this);
      }, false);

      this.clear = document.getElementById("clear");
      this.clear.addEventListener("click", function (e) {
         _this.shoppingCart.clearCart(_this);
      }, false);

      this.checkout = document.getElementById("check");
      this.checkout.addEventListener("click", function (e) {
         _this.shoppingCart.checkOut(_this);
      }, false);
   }
...
var indexer = __webpack_require__(13);
...
var Catalog = function () {
  ...
  _createClass(Catalog, [{
    ...
    value: function initFlickity() {
      var Flickity = __webpack_require__(29);
...
var ShoppingCart = function () {
  ...
  _createClass(ShoppingCart, [{
    ...
    value: function quickViewItems(sku, products, theApp) {
      ...
      document.getElementById("closeWindowq").addEventListener("click", function (e) {
        document.getElementById("quickViewWindow").className = "modal hide";
      }, false);
      document.getElementById("quickViewWindow").className = "modal unhide";
      document.getElementById("QVcontent").innerHTML = output;
      //output="";
    ...
    key: "createCartView",
    value: function createCartView(theApp) {
      var _this = this;
      ...
      for (var i = 0; i < sessionStorage.length - 1; i++) {
        ...
        for (var _i = 0; _i < theApp.products.length; _i++) {
          if (theApp.products[_i].sku.toString() == currentSku) {
            (function () {
              var actualProduct = theApp.products[_i];
              ...
              document.getElementById("removeBtn_" + actualProduct.sku).addEventListener("click", function (e) {
                _this.removeItemFromCart(actualProduct.sku, theApp);
              }, false);
              document.getElementById("updateBtn_" + actualProduct.sku).addEventListener("click", function (e) {
                _this.updateQuantityofItemInCart(actualProduct.sku, theApp);
              }, false);
            })();
          }
        }
        ...
        for (var _i2 = 0; _i2 < CartTotal.length; _i2++) {
          var subtotals = Number(CartTotal[_i2].getAttribute('id'));
          Total += subtotals;
        }
        var addTotal = '<p class="">Total Price: $' + Total.toFixed(2) + '</p>';
        document.getElementById("totalamount").innerHTML = addTotal;
      }

      //Closes Cart when clear
      document.getElementById("clear").addEventListener('click', function () {
        document.getElementById("cartItemView").className = "cartcontainer flex flex-col flex-center-j flex-center-a hide";
      }, false);
    ...
    key: "deleteItem",
    value: function deleteItem(sku, thisShoppingCart) {
      var skuQty = sessionStorage.getItem(sku);
      var oldQty = sessionStorage.getItem('quantity');
      sessionStorage.removeItem(sku);
      var newQty = parseInt(oldQty) - parseInt(skuQty);
    ...
    value: function removeItemFromCart(sku, theApp) {
      ...
      var skuQty = parseInt(sessionStorage.getItem(sku));
      sessionStorage.removeItem(sku);
      var newQuantity = parseInt(sessionStorage.getItem("quantity")) - skuQty;
      ...
      if (CartTotal.length == 0) {
        ...
        var addTotal = '<p class="">Total Price: $ ' + Total + '</p>';
        document.getElementById('totalamount').innerHTML = addTotal;
      }
      this.getCartTotal();
    ...
    value: function updateQuantityofItemInCart(sku, theApp) {
      for (var i = 0; i < sessionStorage.length; i++) {
        var currentSku = sessionStorage.key(i);
        var actualQty = sessionStorage.getItem(currentSku);
        if (sku.toString() == currentSku) {
          var inputSku = document.getElementById("qty_" + sku);
          var inputVal = document.getElementById("qty_" + sku).value;
          sessionStorage.setItem(currentSku, inputVal);
          for (var _i3 = 0; _i3 < sessionStorage.length; _i3++) {
            if (sessionStorage.key(_i3) == "quantity") {
              var newQuantity = sessionStorage.getItem("quantity");
              newQuantity = parseInt(newQuantity);
