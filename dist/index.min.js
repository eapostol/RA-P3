...
var JQuery = __webpack_require__(45);
  ...
  _createClass(ShoppingCart, [{
    ...
    value: function createCartView(theApp) {
      ...
      for (var sku in sessionStorage) {
        ...
        for (var i = 0; i < theApp.products.length; i++) {
          var currentProduct = theApp.products[i];
          if (theApp.products[i].sku.toString() == currentSku) {
            (function () {
              var actualProduct = theApp.products[i];
              ...
              document.getElementById("removeBtn").addEventListener("click", function (e) {
                _this.deleteItem(actualProduct.sku, _this);
              }, false);
          ...
          for (var _i = 0; _i < CartTotal.length; _i++) {
            var subtotals = Number(CartTotal[_i].getAttribute('id'));
            Total += subtotals;
          }
      ...
      document.getElementById("clear").addEventListener('click', function () {
        document.getElementById("cartItemView").className = "cartcontainer hide";
      }, false);
    ...
    value: function deleteItem(sku, thisShoppingCart) {
      ...
      var newQty = parseInt(skuQty);
      var newQty2 = parseInt(oldQty);
      var newQty3 = newQty2 - newQty;
